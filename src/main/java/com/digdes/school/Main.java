...
public class Main {
    ...
    // Тип колонки и тип объекта добавляемого в нее или сравниваемого с ней должны быть одинаковы.
    // То есть для 'lastname' подходят только значения в одинарных кавычках, обозначающих строку.
    // А для cost только вещественные числа, например 10.0, а не 10
